...
public class ClassRef {
    ...
    private ArrayList<com.billkalin.dex.MethodRef> mMethodRefs;
    ...
    public ClassRef(String className) {
        ...
        mMethodRefs = new ArrayList<com.billkalin.dex.MethodRef>();
    }
     ...
     */
    public void addMethod(com.billkalin.dex.MethodRef mref) {
     ...
     */
    public com.billkalin.dex.MethodRef[] getMethodArray() {
