...
public class Main {
    ...
    void run(String[] args) {
        ...
        } catch (com.billkalin.dex.UsageException ue) {
            usage();
            System.exit(2);
     ...
     *
     * @throws com.billkalin.dex.UsageException if arguments are missing or poorly formed
     */
        ...
        for (idx = 0; idx < args.length; idx++) {
            ...
            if (arg.equals("--") || !arg.startsWith("--")) {
                ...
                if (!mOutputFormat.equals("brief") &&
                    ...
                    throw new com.billkalin.dex.UsageException();
                }
